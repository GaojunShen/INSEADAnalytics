...
2.	There would be an error message if I run the command 'myData + StockReturns[1:40,]'. Because class(myData) is data.frame and class(StockReturns) is matrix. They are not the same format and cannot be added up.
